...
export default defineConfig(({ mode }) => ({
  server: {
    ...
    strictPort: false,
    allowedHosts: [
      "6200a603-aca2-41ec-8408-5a623a11af8a-00-xkbyhzmr5g6t.pike.replit.dev","a59b62ab-cc61-4e77-9b72-9106b413f847-00-1jifo6qmua7bw.sisko.replit.dev","39e32fdf-3ff7-4e0b-bbb4-85a879664bd2-00-1jt2cpsdyzvwn.pike.replit.dev",
